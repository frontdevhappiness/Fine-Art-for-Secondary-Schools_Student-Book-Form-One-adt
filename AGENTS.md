# Fine Art for Secondary Schools: Student’s Book Form One — ADT Bundle Reference
...
**Fine Art for Secondary Schools: Student’s Book Form One** — This is an English-language Fine Art textbook for Form One secondary pupils in Tanzania, published by the Tanzania Institute of Education for lower secondary level learners. It introduces the foundations of visual art through drawing, painting, printmaking and sculpture, while also covering colour theory, design principles, simple practical techniques, Tanzanian art movements such as Tingatinga and Makonde sculpture, and safe environmental practice in art work. The book has a strongly competency-based, classroom-focused approach, using activities, exercises, observation and portfolio work to build practical skills, creativity, cultural awareness and basic entrepreneurial understanding.
...
├── FINE-ART-FORM-1--ii-.db                    # SQLite database (pipeline state)
├── FINE-ART-FORM-1--ii-.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania Ministry of Education, Science and Technology for ‘Fine Art for Secondary Schools Student’s Book Form One’. The green certificate, numbered 1224, states that the book was approved on 1 November 2023 as a textbook for Form One students under the 2023 syllabus, and it is signed by Dr Lyabwene M. Mtahabwa, Commissioner for Education.",
  "gl001": "absorbent",
  "gl001_def": "able to soak up liquid easily"
}
```
...
```json
{
  "title": "Fine Art for Secondary Schools: Student’s Book Form One",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
| Original PDF | `FINE-ART-FORM-1--ii-.pdf` |
| Pipeline database | `FINE-ART-FORM-1--ii-.db` (SQLite) |
